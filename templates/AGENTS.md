...
This file is managed by the Pimcore dev runtime and is refreshed on every container start.
Do not edit this file for instance-specific instructions because runtime updates overwrite it.

If `/var/www/.aggro-dev/AGENTS.local.md` exists and is non-empty, read it in addition to this file.
That local file is intentionally never overwritten by the runtime and is the place for persistent instance-specific instructions.
